                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" name="address" type="text" pattern=".{10,50}" title="Please input correct address." value="<?php echo $info->address; ?>" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" name="confirmpassword" id="confirmpassword" type="password" value="" required>
                                        </div>
